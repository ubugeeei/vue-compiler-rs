...
| -------------------------------------- | ----- | ------------------- | ------------------- | ----: | ----: |
| `Analyzer`                             | type  | `analyzer`          | `vize_canon`        |    36 |   143 |
...
| `AnalyzerOptions`                      | type  | `analyzer`          | `vize_canon`        |    36 |   139 |
...
| `Croquis`                              | type  | `croquis`           | `vize_atelier_jsx`  |    13 |    23 |
...
| `Croquis.macros`                       | field | `croquis`           | `vize_canon`        |    19 |    59 |
...
| -------------------------------------- | -------: | ---: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Analyzer`                             |      186 |  275 | `vize_canon` (143/220), `vize_croquis_cf` (40/49), `vize_doctor` (0/1), `vize_maestro` (2/3), `vize_vitrine` (1/2)                                                                                                                                                                                                                                                                                                                                       |
| `AnalyzerOptions`                      |      161 |  276 | `vize_canon` (139/216), `vize_croquis_cf` (19/56), `vize_maestro` (2/3)                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `Croquis`                              |      353 |  558 | `vize` (1/2), `vize_atelier_core` (17/23), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (23/42), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (165/239), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (3/18), `vize_patina` (22/47), `vize_vitrine` (1/4)                                                                                                                                |
...
| `Scope`                                |       19 |   88 | `vize` (0/1), `vize_atelier_core` (0/3), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (0/1), `vize_atelier_sfc` (0/5), `vize_atelier_ssr` (0/3), `vize_canon` (17/48), `vize_davinci` (0/1), `vize_maestro` (0/7), `vize_patina` (2/10), `vize_relief` (0/2), `vize_s1_to_s2` (0/3), `vize_s2` (0/1), `vize_vitrine` (0/2)                                                                                                                               |
| `ScopeBinding`                         |        1 |   25 | `vize_atelier_core` (1/2), `vize_atelier_jsx` (0/2), `vize_s1_to_s2` (0/12), `vize_s2` (0/9)                                                                                                                                                                                                                                                                                                                                                             |
...
| `Span`                                 |        0 |  654 | `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/73), `vize_atelier_sfc` (0/6), `vize_atelier_vapor` (0/1), `vize_canon` (0/56), `vize_carton` (0/89), `vize_davinci` (0/20), `vize_maestro` (0/4), `vize_patina` (0/153), `vize_relief` (0/8), `vize_s1_to_s2` (0/125), `vize_s2` (0/117)                                                                                                                                                               |
...
| `Croquis.bindings`                     |       76 |  684 | `vize` (0/2), `vize_atelier_core` (2/24), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (1/32), `vize_atelier_sfc` (16/224), `vize_atelier_ssr` (0/3), `vize_atelier_vapor` (0/4), `vize_canon` (43/88), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_fresco` (0/6), `vize_maestro` (9/13), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_s1_to_s2` (0/230), `vize_s2` (0/21), `vize_vitrine` (2/7) |
...
| `Croquis.macros`                       |      134 |  254 | `vize_atelier_sfc` (11/102), `vize_canon` (59/61), `vize_croquis_cf` (25/27), `vize_davinci` (0/4), `vize_maestro` (14/24), `vize_musea` (0/2), `vize_patina` (22/31)                                                                                                                                                                                                                                                                                    |
...
| `Croquis.scopes`                       |       80 |  129 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/10), `vize_canon` (40/42), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_patina` (4/17), `vize_s1_to_s2` (0/9)                                                                                                                                                                                                                                                                        |
