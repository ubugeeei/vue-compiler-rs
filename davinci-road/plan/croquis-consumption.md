...
| `Span`                                 |        0 |  652 | `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/71), `vize_atelier_sfc` (0/6), `vize_atelier_vapor` (0/1), `vize_canon` (0/56), `vize_carton` (0/89), `vize_davinci` (0/20), `vize_maestro` (0/4), `vize_patina` (0/153), `vize_relief` (0/8), `vize_s1_to_s2` (0/125), `vize_s2` (0/117)                                                                                                                                                               |
...
| `Croquis.bindings`                     |       76 |  678 | `vize` (0/2), `vize_atelier_core` (2/24), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (1/26), `vize_atelier_sfc` (16/224), `vize_atelier_ssr` (0/3), `vize_atelier_vapor` (0/4), `vize_canon` (43/88), `vize_croquis_cf` (2/10), `vize_curator` (0/1), `vize_davinci` (0/10), `vize_fresco` (0/6), `vize_maestro` (9/13), `vize_musea` (0/1), `vize_patina` (1/6), `vize_relief` (0/1), `vize_s1_to_s2` (0/230), `vize_s2` (0/21), `vize_vitrine` (2/7) |
...
| `Croquis.scopes`                       |       80 |  125 | `vize` (0/1), `vize_atelier_core` (0/4), `vize_atelier_jsx` (0/6), `vize_canon` (40/42), `vize_curator` (0/1), `vize_davinci` (0/9), `vize_patina` (4/17), `vize_s1_to_s2` (0/9)                                                                                                                                                                                                                                                                         |
