...
| `Croquis`                              | type  | `croquis`           | `vize_canon`        |    68 |   168 |
...
| `Croquis`                              |      357 |  564 | `vize` (1/2), `vize_atelier_core` (17/23), `vize_atelier_dom` (2/6), `vize_atelier_jsx` (24/43), `vize_atelier_sfc` (17/43), `vize_atelier_ssr` (1/4), `vize_canon` (168/244), `vize_carton` (0/1), `vize_croquis_cf` (101/127), `vize_davinci` (0/2), `vize_maestro` (3/18), `vize_patina` (22/47), `vize_vitrine` (1/4)                                                                                                                                |
