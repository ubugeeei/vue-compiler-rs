...
| `Scope`                                |       19 |   87 | `vize` (0/1), `vize_atelier_core` (0/3), `vize_atelier_dom` (0/1), `vize_atelier_jsx` (0/1), `vize_atelier_sfc` (0/5), `vize_atelier_ssr` (0/3), `vize_canon` (17/48), `vize_davinci` (0/1), `vize_maestro` (0/7), `vize_patina` (2/10), `vize_relief` (0/2), `vize_s1_to_s2` (0/2), `vize_s2` (0/1), `vize_vitrine` (0/2)                                                                                                                               |
...
| `Span`                                 |        0 |  657 | `vize_atelier_core` (0/2), `vize_atelier_jsx` (0/73), `vize_atelier_sfc` (0/6), `vize_atelier_vapor` (0/1), `vize_canon` (0/56), `vize_carton` (0/89), `vize_davinci` (0/20), `vize_maestro` (0/4), `vize_patina` (0/153), `vize_relief` (0/8), `vize_s1_to_s2` (0/128), `vize_s2` (0/117)                                                                                                                                                               |
